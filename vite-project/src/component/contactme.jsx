...
const ContactMeSection = () => {
  return (
    ...
    <div className="right-contact">
        <ul className="contact-list">
            <li className="contact-item"><span>: Bhagalpur, Bihar (IN)</span></li>
            <li className="contact-item"><span>: amit.ece.21@nitap.ac.in</span></li>
            <li className="contact-item"><span>: National Institute of Technology Arunachal Pradesh</span></li>
            <li className="contact-item"><span>: +91 9472503812</span></li>
            <li className="contact-item"><span>: English, Hindi</span></li>
        </ul>
    </div>
</div>
